...
/**
 * `mh-oportunidad-citas` Reporte de oportunidad de citas.
 *
 * @customElement
 * @polymer
 * @demo
 *
 */
class MedhisOportunidadCitas extends LitElement {
...
customElements.define('mh-oportunidad-citas', MedhisOportunidadCitas);
