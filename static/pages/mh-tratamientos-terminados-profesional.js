...
const groupByCliente = (obj, tratamiento) => {
    // eslint-disable-next-line object-curly-newline
...
/**
 * `mh-tratamientos-terminados-profesional` Reporte con los tratamientos terminados y auditados
 ...
 *
 */
class MedhisTratamientosTerminadosProfesional extends ApolloQuery {
    ...
    constructor() {
        ...
        this.query = gql`
            query TratamientosTerminadosProfesional($institucion: ID!, $medico: ID!, $entre: String!) {
                tratamientos(auditoriaFinal: true, medico: $medico, institucion: $institucion terminaronEntre: $entre) {
                    results {
                        id
                        valor
                        ordenUrl
    ...
    _setData() {
        ...
        this.reportData = Object.values(tratamientos.reduce(groupByCliente, {}));
        this.totalPagar = this.reportData.reduce((total, actual) => total + actual.totalPagar, 0);
    }
}

customElements.define('mh-tratamientos-terminados-profesional', MedhisTratamientosTerminadosProfesional);
