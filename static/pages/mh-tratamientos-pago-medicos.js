...
/**
 * `mh-tratamientos-pago-medicos` Relacion de tratamientos para pago de medicos.
 *
 * @customElement
 * @demo
 * 
 */
class MedhisTratamientosPagoMedicos extends ApolloQuery {
                        ...
                        <range-datepicker-input .dateFrom="${desde}" .dateTo="${hasta}"
                            ...
                            <template>
                                <div style="display: grid; grid-gap: 10px; grid-template-columns: 1fr 1fr;">
                                    <paper-input required label="Terminados desde *" value="[[dateFrom]]"></paper-input>
                                    <paper-input required label="Terminados hasta *" value="[[dateTo]]"></paper-input>
                                </div>
                            </template>
...
customElements.define('mh-tratamientos-pago-medicos', MedhisTratamientosPagoMedicos);
