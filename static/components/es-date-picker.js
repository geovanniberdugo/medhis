...
/**
 * `es-date-picker` Wrapper to update Vaadin-date-picker to spanish.
 *
 * @customElement
 * @polymer
 * @demo
 *
 */
class EsDatePicker extends PolymerElement {
    ...
    ready() {
        ...
        afterNextRender(this, () => {
            ...
            slottedElements.forEach(elem => elem.i18n = this.i18n);
        });
    }
}

customElements.define('es-date-picker', EsDatePicker);
